...
const Services = () => {
  return (
    ...
    >
      ...
      {/* Affordable prices */}
      <div className="pt-[25px] md:pt-[75px] flex flex-col lg:flex-row gap-[55px] lg:gap-[100px] justify-between overflow-visible">
        <div className="max-w-[527px] pt-[40px] md:pt-[100px] flex flex-col space-y-4">
        ...
        <div className="relative max-w-[478px] overflow-visible">
          <div className="relative w-[378px] h-[379px] overflow-visible">
            <img
              ...
              alt=""
            />
            <img className="w-full h-full" src={assets.Image5} alt="" />
          </div>
        </div>
      </div>
    </div>
